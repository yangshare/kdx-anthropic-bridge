...
把重试下沉到 bridge:bridge 收到 Claude Code 请求后,若上游返回 502/503/429/529,
...
- 重试状态码:502、503、429、529(网关类瞬时错误;529 为非标准"Site is overloaded"码,智谱 GLM 过载时返回)
...
| 字段 | 不填默认 | 说明 |
|---|---|---|
| `max_retries` | 0(不重试) | 502/503/429/529 最大重试次数(不含首次) |
